...
def tidy_video(input: str, output: str) -> None:
    ...
    for item in tqdm(items):
        ...
        video_mapping['region_allowed'] = str(
            region_restriction.get('allowed')) \
            if region_restriction else None
        video_mapping['region_blocked'] = str(
            region_restriction.get('blocked')) \
            if region_restriction else None
...
def tidy_channel(input: str, output: str) -> None:
    ...
    for item in tqdm(items):
        ...
        channel_mapping['localized_description'] = snippet['localized'][
            'description']
        channel_mapping['related_playlists_likes'] = related_playlists.get(
            'likes') if related_playlists else None
        channel_mapping['related_playlists_uploads'] = related_playlists.get(
            'uploads') if related_playlists else None
        ...
        channel_mapping['topic_categories'] = str(
            topic_details.get('topicCategories')) if topic_details else None
...
def tidy_comments(input, output) -> None:
    ...
    for item in tqdm(items):
        ...
        comment_mapping['video_id'] = snippet['videoId']
