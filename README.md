...
Usage: youtupy search [OPTIONS] QUERY  
  ...
  Do a YouTube search.  
Options:  
  -o, --output TEXT    Output jsonl file. Ends in `.jsonl`.  
...
```commandline  
Usage: youtupy hydrate [OPTIONS] FILEPATH  
  
  Hydrate video or channel ids.  
  Get all metadata for a list of video or channel IDs. By default, the  function hydrates video IDs.  
Options:  
  -o, --output TEXT    Output jsonl file. Ends in `.jsonl`.  
...
```  
youtupy list-comments video_ids.csv -v -o comments_for_videos.jsonl  
youtupy list-comments comment_ids.csv -o comments.jsonl  
youtupy list-comments comment_ids.csv -p -o replies_to_comments.jsonl  
```  
...
```commandline  
Usage: youtupy tidy [OPTIONS] FILEPATH  
  
  Tidy raw JSON response into relational SQLite databases  
Options:  
  -o, --output TEXT  Output database file. Ends in `.db`.  
  --help             Show this message and exit.  
```  
